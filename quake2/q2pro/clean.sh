#!/usr/bin/env bash
rm -f items.txt
rm -f {3zb2,baseq2,jump,openffa,opentdm,openra2,tdm}/{config.cfg,.conhistory,.syshistory,q2config.cfg,debug.log}
rm -rf {3zb2,baseq2,jump,openffa,opentdm,openra2,tdm}/demos
rm -rf {3zb2,baseq2,jump,openffa,opentdm,openra2,tdm}/logs
